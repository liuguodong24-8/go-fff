...
async function test() {
  console.log(`3f contract erc20 balance`)
}
test().then(async function () {
  ...
  const contractAddress = 'FFF3nzqcdAMAQh8cWLS7jz5RDJxYNBJAAGNJB8dByFeyqwE6D2r7nHgHuc'
  ...
  const data = await incrementer.methods.balanceOf(to0xAddress(address)).call();
  console.log(`The current number banance is: ${data}`);
})
